...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            <li><a href="{!! URL::to(ADMIN_SLUG.'/currency/create') !!}"><i class="fa fa-plus-square"></i> {!! trans('admin/currency.add_currency') !!}</a></li>
        </ol>
    </section>
    <!-- Main content -->
                ...
                <div class="box">
                    <div class="box-body table-responsive">
                        <table id="currency_list" class="table table-bordered">
                            <thead>
                                <tr>
                                    <th width="30%">{!! trans('admin/currency.currency_name') !!}</th>
                                    <th width="20%">{!! trans('admin/currency.currency_code') !!}</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        oTable = $('#currency_list').dataTable({
            ...
            "processing": true,
            "serverSide": true,
            "ajax": "{!! url(ADMIN_SLUG.'/currency/CurrencyData') !!}",
            "columnDefs": [
        ...
        $("#currency_list").on('click', '.status-btn', function () {
            ...
            $.ajax({
                type: "POST",
                url: "/{!! ADMIN_SLUG !!}/currency/changeStatus",
                data: {
                    id: id,
                    _token: "{!! csrf_token() !!}"
                },
